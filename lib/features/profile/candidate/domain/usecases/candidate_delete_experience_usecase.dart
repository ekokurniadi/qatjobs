...
@injectable
class CandidateDeleteExperienceUseCase implements UseCase<bool, int> {
  final CandidateProfileRepository _repository;

  const CandidateDeleteExperienceUseCase(this._repository);

  @override
  Future<Either<Failures, bool>> call(
    int id,
  ) async {
    return await _repository.deleteExperience(id);
  }
}
