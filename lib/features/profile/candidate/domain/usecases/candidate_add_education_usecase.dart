...
@injectable
class CandidateAddEducationUseCase implements UseCase<bool, CandidateEducationModels> {
  final CandidateProfileRepository _repository;

  const CandidateAddEducationUseCase(this._repository);

  @override
  Future<Either<Failures, bool>> call(
    CandidateEducationModels params,
  ) async {
    return await _repository.addEducation(params);
  }
}