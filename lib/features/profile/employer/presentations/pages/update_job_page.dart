            ...
            children: [
                    ...
                    builder: (context, state) {
                      return DropdownSearchWidget(
                        selectedItem: state.types.firstWhereOrNull(
                          (element) => element.id == selectedJobTypeId.value,
                        ),
                        onChanged: (type) {
              ...
              Container(
                ...
                child: BlocProvider(
                  ...
                  child: BlocBuilder<JobSkillBloc, JobSkillState>(
                    builder: (context, state) {
                      return DropdownSearchMultiSelectWidget<JobsSkillEntity>(
                        isRequired: true,
                    ...
                    builder: (context, state) {
                      return DropdownSearchWidget(
                        ...
                        selectedItem: state.currency.firstWhereOrNull(
                          (element) => element.id == selectedCurrencyId.value,
                        ),
                        onChanged: (type) {
              ...
              Container(
                ...
                child: BlocProvider(
                  ...
                  child: BlocBuilder<FunctionalAreaBloc, FunctionalAreaState>(
                    builder: (context, state) {
