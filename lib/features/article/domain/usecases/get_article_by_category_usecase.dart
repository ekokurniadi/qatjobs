...
class GetArticleByCategoryUseCase
    implements UseCase<List<ArticleModel>, PagingRequestParams> {
  final ArticleRepository _articleRepository;

  GetArticleByCategoryUseCase({
    required ArticleRepository articleRepository,
  }) : _articleRepository = articleRepository;

  @override
  Future<Either<Failures, List<ArticleModel>>> call(
      PagingRequestParams params) async {
    return await _articleRepository.getArticleByCategory(params);
  }
}
